	...
	<div class="row-3">
		<div class="kontener">
			...
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ touch cakesControllersFrontend.mjs</code>
				</p>
			</div>
		</div>
		<div class="kontener">
			...
			<p>
				<code>cakesControllersFrontend.mjs</code>
			</p>
			<a href="./alkalmazas_js/04_blokk/megoldasok/cakesControllersFrontend.mjs" download>
		...
		<div class="kontener">
			...
			<p>
				Ehhez adjuk ki a <code>touch cakesControllersFrontend.mjs</code> utasítást a parancssorban. 
			</p>
			<p>
		...
		<div class="kontener">
			<h3>Magyarázat:</h3>
			<p>
				A folyamat hasonló a <code>backend/controllers/cakes/cakesControllersBackend.mjs</code> állományban vázoltakhoz.
			</p>
		</div>
	</div>
	`;
