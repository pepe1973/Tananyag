let betolt_13 = `
    ...
    <p>Következő lépésként beállítjuk az <span class="kiemel">API</span>-nk környezeti változóit.</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
			<div class="kod-kontener">
				...
				<p><code class="parancs">$ touch .env</code></p>
			</div>
		</div>
		<div class="kontener">
			...
			<pre>
PORT=3500
DBSTRING=saját adatbázis sztring/Cukraszda
CLOUDINARY_API_CLOUD_NAME="saját felhőnév"
CLOUDINARY_API_KEY="saját API kulcs"
CLOUDINARY_API_SECRET="saját API titkos kulcs"
			</pre
			>
		</div>
		<div class="kontener">
