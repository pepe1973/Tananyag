let betolt_01_jobb_02 = `
	...
	<div class="row-3">
		...
		<div class="kontener">
			...
			<ol>
				<li>
					<b>Dependency (függőség):</b> Egy osztály vagy komponens, amelyre egy másik osztálynak szüksége
					van a működéséhez.
				</li>
				<li>
					<b>Injection (befecskendezés):</b> Külső függőség ellátása egy osztály számára.
				</li>
			</ol>
		</div>
	</div>
