let betolt_01_jobb_04 = `
	...
	<div class="row-3">
		<div class="kontener">
			...
			<p>
				<a href="https://www.w3schools.com/react/react_usecontext.asp" target="_blank">w3schools: useContext()</a>
			</p>
		</div>
		<div class="kontener">
			<h3>Fogalom:</h3>
			...
			<p>
				<a href="https://www.w3schools.com/react/react_useref.asp" target="_blank">w3schools: useRef()</a>
			</p>
		</div>
		<div class="kontener">
			<h3>Fogalom:</h3>
			...
			<p>
				<a href="https://www.w3schools.com/react/react_usereducer.asp" target="_blank">w3schools: useReducer()</a>
			</p>
		</div>
		<div class="kontener">
			<h3>Fogalom:</h3>
			...
			<p>
				<a href="https://www.w3schools.com/react/react_usecallback.asp" target="_blank">w3schools: useCallback()</a>
			</p>
		</div>
	</div>
	`;
