let betolt_17 = `
    ...
    <p>Következő lépésként létrehozzuk az oldalon való navigációhoz a <code>Navbar.jsx</code> állományt.</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
		...
		<div class="kontener">
			...
			<pre>
<span class="kiemel">import { Link } from 'react-router-dom';
import './Navbar.css';</span>

const Navbar = () => {
    return (
        &lt;div className="navbar-kontener"&gt;
            &lt;div className="frontend-nav"&gt;
                <span class="kiemel">&lt;Link to="/"&gt;Home&lt;/Link&gt;
                &lt;Link to="/cakes"&gt;Torták&lt;/Link&gt;</span>
            &lt;/div&gt;
            &lt;div className="backend-nav"&gt;
                <span class="kiemel">&lt;Link to="http://localhost:3500/api"&gt;Szerver&lt;/Link&gt;</span>
            &lt;/div&gt;
        &lt;/div&gt;
    );
};
