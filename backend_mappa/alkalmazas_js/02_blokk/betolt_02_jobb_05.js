let betolt_02_jobb_05 = `
	<h1>Verziókövetés beállítása</h1> 
    <p>
		Következő lépésként beállítjuk, hogy mely mappák és állományok ne töltödjenek
		fel a <span class="kiemel">távoli repository</span>ba (<span class="kiemel">GitHub</span>).
	</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ touch .gitignore</code>
				</p>
			</div>
		</div>
		<div class="kontener">
			...
			<a href="./alkalmazas_js/02_blokk/megoldasok/gitignore.txt" download>
				<img src="./alkalmazas_js/02_blokk/images/kep_04.png" title="A képre kattintva a kód letölthető!" />
			</a>
		</div>
		<div class="kontener">
			<h3>Magyarázat:</h3>
...
export default betolt_02_jobb_05;
