let betolt_02_jobb_02 = `
    ...
    <p>
		Ebben a részben kialakítjuk a mappastruktúrát.
	</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ mkdir controllers middlewares models public routes utils views</code>
				</p>
			</div>
		</div>
		<div class="kontener">
		...
		<div class="kontener">
			...
			<p>
				Ehhez adjuk ki az
				<code>mkdir controllers middlewares models public routes utils views</code>
