let betolt_02_jobb_06 = `
	<h1>Webszerver létrehozása</h1> 
    <p>
		Következő lépésként létrehozzuk a <span class="kiemel">webszerver</span>ünket.
	</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ touch server.mjs</code>
				</p>
			</div>
			...
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ node --watch server.mjs</code>
				</p>
			</div>
		</div>
		<div class="kontener">
			...
			<a href="./alkalmazas_js/02_blokk/megoldasok/server.mjs" download>
				<img src="./alkalmazas_js/02_blokk/images/kep_05.png" title="A képre kattintva a kód letölthető!" />
			</a>
		</div>
		<div class="kontener">
			<h3>Magyarázat:</h3>
...
export default betolt_02_jobb_06;
