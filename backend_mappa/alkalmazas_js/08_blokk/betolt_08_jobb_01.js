	...
	<div class="row-3">
		<div class="kontener">
			...
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ touch newCakeControllers.mjs</code>
				</p>
			</div>
		</div>
		<div class="kontener">
			...
			<a href="./alkalmazas_js/08_blokk/megoldasok/server.mjs" download>
				<img src="./alkalmazas_js/08_blokk/images/kep_01.png" title="A képre kattintva a kód letölthető!" />
			</a>
		</div>
		<div class="kontener">
			<h3>Magyarázat:</h3>
			...
			<p>
				Ehhez adjuk ki a <code>touch newCakeControllers.mjs</code> utasítást a parancssorban. 
			</p>
			<p>
...
export default betolt_08_jobb_01;
