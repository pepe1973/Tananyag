let betolt_08_jobb_03 = `
	<h1>A <code>public/js</code> mappában lévő <code>torta.mjs</code> állomány szerkesztése.</h1> 
    <p>
		Ebben a lépésben kidolgozzuk a <code>feltoltes(event)</code> függvényt a
		<code>public/jd/torta.mjs</code> állományban.
	</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ touch torta.mjs</code>
				</p>
			</div>
		</div>
		<div class="kontener">
			...
			<a href="./alkalmazas_js/08_blokk/megoldasok/torta.mjs" download>
				<img src="./alkalmazas_js/08_blokk/images/kep_04.png" title="A képre kattintva a kód letölthető!" />
			</a>
		</div>
		<div class="kontener">
			<h3>Magyarázat:</h3>
			...
			<p>
				Ehhez adjuk ki a <code>touch torta.mjs</code> utasítást a parancssorban. 
			</p>
			<p>
...
export default betolt_08_jobb_03;
