let betolt_07_jobb_04 = `
	<h1>A <code>public/js</code> mappában lévő <code>tortak.mjs</code> állomány szerkesztése</h1> 
    <p>
		Ebben a lépésben kidolgozzuk a <code>torol(id)</code> függvényt a <code>public/jd/tortak.mjs</code> állományban.
	</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ mkdir js</code>
				</p>
				<p>
					<code>User@ALAP-SZAMITOGEP <span class="git-lila">MINGW64</span> <span class="git-sar">~/Desktop/Cukraszda/backend/public</span></code>
				</p>
				...
				<p>
					<code class="parancs">$ touch tortak.mjs</code>
				</p>
			</div>
		</div>
		<div class="kontener">
			...
			<p>
				<code>tortak.mjs</code>
			</p>
			<a href="./alkalmazas_js/07_blokk/megoldasok/tortak.mjs" download>
				<img src="./alkalmazas_js/07_blokk/images/kep_05.png" title="A képre kattintva a kód letölthető!" />
			</a>
		</div>
		<div class="kontener">
			<h3>Magyarázat:</h3>
			...
			<p>
				Ehhez adjuk ki a <code>mkdir js</code> utasítást a parancssorban. 
			</p>
			<p>
			...
			<p>
				Ehhez adjuk ki a <code>touch tortak.mjs</code> utasítást a parancssorban. 
			</p>
			<p>
...
export default betolt_07_jobb_04;
