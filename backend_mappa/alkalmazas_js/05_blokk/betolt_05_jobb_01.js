let betolt_05_jobb_01 = `
    ...
    <p>
		Első lépésként az <span class="kiemel">MVC</span>-vel összefüggésben létrehozzuk a fenti állományt.
		Ebben dolgozzuk ki a <span class="kiemel">CRUD</span> műveleteket.
	</p>
	<div class="row-3">
		<div class="kontener">
			<h3>Parancssor:</h3>
			<div class="kod-kontener">
				...
				<p>
					<code class="parancs">$ touch mainControllersBackend.mjs</code>
				</p>
			</div>
		</div>
		<div class="kontener">
			...
			<a href="./alkalmazas_js/05_blokk/megoldasok/mainControllersBackend.mjs" download>
